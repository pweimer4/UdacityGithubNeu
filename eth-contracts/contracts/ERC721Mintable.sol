...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused, "Contract is currently not paused by the owner");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        require(owner != address(0), "Zero addresses do not have any balance here");
...
contract ERC721Mintable is ERC721Metadata {
    ...
    string private _name = "NFT Real Estate"; 
    string private _symbol = "NRE"; 
